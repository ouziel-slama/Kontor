...
#[tokio::test]
async fn test_pre_sign_node_refuses_on_underfunded_script_output() -> Result<()> {
...
#[tokio::test]
async fn test_pre_sign_node_refuses_on_reveal_output_remap() -> Result<()> {
...
#[tokio::test]
async fn test_reordering_commit_inputs_rejected() -> Result<()> {
...
#[tokio::test]
async fn test_reordering_commit_outputs_rejected() -> Result<()> {
...
#[tokio::test]
async fn test_portal_cannot_steal_change_rejected() -> Result<()> {
...
#[tokio::test]
async fn test_node_cannot_steal_in_reveal_rejected() -> Result<()> {
