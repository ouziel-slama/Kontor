...
/// Challenge status for Proof of Retrievability
...
impl From<ChallengeStatus> for i64 {
    fn from(status: ChallengeStatus) -> Self {
        status as i64
    }
}

/// Database row for storage challenges
#[derive(Debug, Clone, Serialize, Deserialize, Builder, Eq, PartialEq)]
...
impl HasRowId for ChallengeRow {
    fn id(&self) -> i64 {
        self.id
    }
...
#[serde_as]
#[derive(Debug, Clone, Serialize, Deserialize, Builder, Eq, PartialEq, Default)]
