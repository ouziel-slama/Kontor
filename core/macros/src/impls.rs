    ...
    quote! {
        ...
        impl std::ops::Add for kontor::built_in::numbers::Integer {
            ...
            fn add(self, other: Self) -> Self::Output {
                #numerics_mod_name::add_integer(self, other).unwrap()#numerics_unwrap
            }
        }
        ...
        impl std::ops::Sub for kontor::built_in::numbers::Integer {
            ...
            fn sub(self, other: Self) -> Self::Output {
                #numerics_mod_name::sub_integer(self, other).unwrap()#numerics_unwrap
            }
        }
        ...
        impl std::ops::Mul for kontor::built_in::numbers::Integer {
            ...
            fn mul(self, rhs: Self) -> Self {
                #numerics_mod_name::mul_integer(self, rhs).unwrap()#numerics_unwrap
            }
        }
        ...
        impl std::ops::Div for kontor::built_in::numbers::Integer {
            ...
            fn div(self, rhs: Self) -> Self {
                #numerics_mod_name::div_integer(self, rhs).unwrap()#numerics_unwrap
            }
        }
        ...
        impl From<&str> for kontor::built_in::numbers::Integer {
            fn from(s: &str) -> Self {
                #numerics_mod_name::string_to_integer(s).unwrap()#numerics_unwrap
            }
        }
        ...
        impl std::fmt::Display for kontor::built_in::numbers::Decimal {
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                let s = #numerics_mod_name::decimal_to_string(*self)#numerics_unwrap;
                write!(f, "{}", s)
            }
        }
        ...
        impl std::ops::Add for kontor::built_in::numbers::Decimal {
            ...
            fn add(self, other: Self) -> Self::Output {
                #numerics_mod_name::add_decimal(self, other).unwrap()#numerics_unwrap
            }
        }
        ...
        impl std::ops::Sub for kontor::built_in::numbers::Decimal {
            ...
            fn sub(self, other: Self) -> Self::Output {
                #numerics_mod_name::sub_decimal(self, other).unwrap()#numerics_unwrap
            }
        }
        ...
        impl std::ops::Mul for kontor::built_in::numbers::Decimal {
            ...
            fn mul(self, rhs: Self) -> Self {
                #numerics_mod_name::mul_decimal(self, rhs).unwrap()#numerics_unwrap
            }
        }
        ...
        impl std::ops::Div for kontor::built_in::numbers::Decimal {
            ...
            fn div(self, rhs: Self) -> Self {
                #numerics_mod_name::div_decimal(self, rhs).unwrap()#numerics_unwrap
            }
        }
        ...
        impl From<&str> for kontor::built_in::numbers::Decimal {
            fn from(s: &str) -> Self {
                #numerics_mod_name::string_to_decimal(s).unwrap()#numerics_unwrap
            }
        }
